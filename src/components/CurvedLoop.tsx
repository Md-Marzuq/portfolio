...
const CurvedLoop: FC<CurvedLoopProps> = ({
  ...
  const totalText = new Array(repetitions).fill(text).join("");
  ...
  return (
    ...
    >
      ...
      >
        ...
        {ready && (
          <text className={`fill-current ${className}`} xmlSpace="preserve">
            <textPath
              href={`#${pathId}`}
              ref={textPathRef}
