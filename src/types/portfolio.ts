...
export type Project = {
  ...
  image?: string | string[]; // preview image path or fallback array of images
  images?: string[]; // optional additional project images
  href?: string; // live url (for playground)
  isDemoEnabled?: boolean; // enable the demo button when the link is ready
